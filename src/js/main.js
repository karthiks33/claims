...
requirejs.config(
         ...
         */
        require(['ojs/ojcore', 'knockout', 'appController', 'jquery', 'registry', 'ojs/ojknockout',
            'ojs/ojmodule', 'ojs/ojrouter', 'ojs/ojnavigationlist', 'ojs/ojbutton', 'ojs/ojtoolbar'],
                function (oj, ko, app, $, registry) { // this callback gets executed when all required modules are loaded
                    ...
                    $(function () {
                        ...
                        self.closeNotification = function (event) {
                            $("#notification").hide();
                        }
